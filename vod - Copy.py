...
def fight_skeletons():
    ...
    class Skeleton:
        ...
        def attack(self):
            ...
            if random.randint(2,3) == 2:
                print("The skeleton attacks, landing a hit on you. Ouch!")
                return(1)
            else:
    ...
    while skel1.health + skel2.health > 0:
        choices = []
        print(LIGHT_CYAN + f"Round {1}:  You have {health} points left. Skeletons points are 1:{skel1.health}  2:{skel2.health}")
        ...
        health -= skel2.attack()
        if health <= 0:
            print("The skeletons continue hacking at your lifeless body until the spirits are appeased.")
...
def narr_print(string, colour = ITALIC + LIGHT_WHITE, delay = 0.009): #! -- Narrator Print
